...
func setup() *World {
	...
	world := &World{pixels: []Pixel{
		{x: Width * 0.5, y: Height * 0.2, color: color.RGBA{255, 0, 0, 255}, w: pixelSize, h: pixelSize},
		{x: Width * 0.5, y: Height * 0.4, color: color.RGBA{0, 255, 0, 255}, w: pixelSize, h: pixelSize},
		{x: Width * 0.5, y: Height * 0.6, color: color.RGBA{0, 0, 255, 255}, w: pixelSize, h: pixelSize},
		{x: Width * 0.5, y: Height * 0.8, color: color.RGBA{255, 255, 255, 255}, w: pixelSize, h: pixelSize},
	}}
